...
TYPE_COMMENTS = {
    "CP": "批判的な親。責任感や倫理観が強く、きちんとした姿勢を大切にする傾向があります。",
    "NP": "養育的な親。思いやりや共感力が高く、人を支える力がある傾向があります。",
    "A": "おとな。冷静に考え、客観的に判断する力が高い傾向があります。",
    "FC": "自由な子ども。自由さや好奇心、感情の豊かさが強みとして表れやすい傾向があります。",
    "AC": "順応した子ども。周囲への配慮や適応力が高く、人間関係を円滑に保つ力があります。",
}
